...
#nginx['custom_nginx_config'] = "include /var/opt/gitlab/nginx/conf/nginx-cors.conf;"
nginx['custom_gitlab_server_config'] = "include /var/opt/gitlab/nginx/conf/nginx-cors.conf;"
